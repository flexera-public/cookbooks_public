...
attribute "rs_utils/timezone",
  ...
  :required => "optional",
  :default => "UTC",
  :recipes => [ "rs_utils::timezone", "rs_utils::default" ]
...
attribute "rs_utils/process_list",
  ...
  :required => "optional",
  :default => "",
  :recipes => [ "rs_utils::install_mysql_collectd_plugin", "rs_utils::monitoring", "rs_utils::default" ]
...
attribute "rs_utils/private_ssh_key",
  ...
  :required => "optional",
  :default => "",
  :recipes => [ "rs_utils::ssh", "rs_utils::default" ]

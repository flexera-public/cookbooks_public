...
attribute "rails/db_app_user",
  ...
  :required => true,
  :recipes => ["app_rails::do_db_restore", "app_rails::do_update_code", "app_rails::setup_db_config", "app_rails::install_rails" ]
...
attribute "rails/db_mysqldump_file_path",
  ...
  :recipes => ["app_rails::do_db_restore", "app_rails::setup_db_config"]

...
recipe  "db::do_dump_continuous_export", "Creates a entry for a daily run of db::do_dump_export."
...
attribute "db/dump/storage_account_provider",
  ...
  :required => "required",
  :choice => [ "S3", "CloudFiles" ],
  :recipes => [ "db::do_dump_export", "db::do_dump_import" , "db::do_dump_continuous_export" ]

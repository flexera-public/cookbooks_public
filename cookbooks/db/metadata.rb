...
recipe  "db::setup_privileges_admin", "Adds the username and password for 'superuser' privileges. (Premium Account Only)"
recipe  "db::setup_privileges_application", "Adds username and password for application privileges. (Premium Account Only)"

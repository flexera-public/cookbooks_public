...
recipe  "db_postgres::do_set_slave_sync_mode", "Setup master sync mode for replication"
recipe  "db_postgres::do_set_slave_async_mode", "Setup master async mode for replication"
recipe  "db_postgres::do_show_slave_sync_mode", "Show the status of slave syncing state"
